...
## Integration Architecture — BizTalk→Cityworks (DPW) confirmed; non-DPW flows need clarity
...
## Mobile Experience — 3.0★ Android (52), 3.5★ iOS (13); fix sign-in, search, crashes
...
| **Socrata (Legacy Data)** | Open dataset (vgg4-hjn8) | Contains historical SeeClickFix data (2014-2018), but not live Dynamics data. |
