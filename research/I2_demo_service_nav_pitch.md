 ...
 *Answer:* "Based on our back-test against the labeled Socrata dataset, we achieved [X]% accuracy. More importantly, our UI exposes uncertainty to the user, ensuring that low-confidence routes are caught by human triage rather than misfiled."
