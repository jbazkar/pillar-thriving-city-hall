# Richmond’s Digital Services: Foundation Built, Recognition Pending

## Executive Summary
Richmond has established a solid foundation for digital service delivery, marked by ongoing investments in utility modernization, online permitting, and open data. However, the City currently lacks the national recognition and published strategic frameworks that distinguish its Virginia peers. While cities like Virginia Beach and Norfolk consistently rank in the Center for Digital Government’s Digital Cities Survey and achieve What Works Cities certification, Richmond remains absent from these recent top-tier lists. 

The City's Office of Information Technology (OIT) and Citizen Service & Response (311) are structurally aligned under the Finance and Administration portfolio, providing a strong governance baseline. Yet, the absence of a publicly available, unified Digital Service Strategy or IT Master Plan obscures the City's long-term technology vision. For civic tech innovators and hackathon participants, this landscape presents clear opportunities: while core enterprise systems (like the upcoming Customer Information System and Advanced Metering Infrastructure) require City-level procurement and multi-year timelines, there is immediate potential to prototype unified payment launchers, permit tracking dashboards, and 311 performance visualizations that bridge the gap between existing infrastructure and resident experience.
...
## Local Strategy and Governance

### OIT’s Role and Assets
Richmond’s Office of Information Technology (OIT) provides foundational digital assets for the city. The OIT web presence highlights the City's Open Data portal, mapping applications, property search tools, and real-time traffic information [6]. The Open Data portal specifically aims to provide data to the public in an open format, serving as a critical building block for transparency and civic tech development [6].
...
### Permitting Portal Capabilities
The City has digitized its permitting process through the Online Permit Portal. This system allows customers to submit plans for review, apply and pay for permits, request inspections, and check the status of their requests online [12]. 

## 311 History and Current State
...
Richmond's digital maturity can be contextualized by comparing its external recognition and signature initiatives against Virginia peer cities.
...
## Infrastructure-to-Service Linkage

To translate technology platforms into measurable resident outcomes, Richmond must tie its infrastructure investments to clear service-level targets. The Strategic Plan's focus on DPU metrics (billing accuracy, self-service adoption) [9] is a strong start. The City should expand this approach by defining 3–5 "North Star" service KPIs across all departments (e.g., 311 time-to-close, permit cycle time) and publishing progress quarterly. Additionally, expanding high-value open datasets will enable third-party and civic tech contributions, multiplying the City's internal capacity.

## Hackathon vs. City-Level Investment

Understanding the boundary between rapid prototyping and enterprise IT procurement is critical for actionable digital strategy.

| Focus Area | Hackathon Prototype (Under 90 Days) | City-Level Investment (6–24 Months) |
| :--- | :--- | :--- |
| **Payments** | Unified "RVA Pay" launcher UI, status tracking, and deep-link directory. | Payment orchestration layer, Single Sign-On (SSO), vendor consolidation. |
| **311 / Service** | Public performance dashboard using open data; issue intake wizard UI. | CRM integration, category redesign, backend channel consolidation. |
| **Permitting** | "Permit Tracker" app with milestone visualizations and push notifications. | Business Process Management (BPM) redesign, API/webhook exposure. |
| **Utilities CX** | Billing explainer mockups, AMI usage insight dashboards. | CIS/AMI enterprise implementation, core customer portal integration [9]. |
| **Alerts** | Cross-touchpoint opt-in prompts; preference center UX patterns. | Enterprise communications governance, CivicReady integration [9]. |

*Takeaway:* Prototypes can substantially improve findability, transparency, and user experience layers, while core platform changes require formal procurement, API development, and governance.
...
* **30 Days:** Publish a draft Digital Service Strategy outline. Select three high-volume resident journeys (e.g., paying a utility bill, reporting a pothole, checking a permit). Confirm KPI baselines and secure data access for civic tech partners.
* **60 Days:** Ship two resident-facing prototypes (e.g., a Permit Tracker and a unified RVA Pay launcher). Initiate a What Works Cities self-assessment with external support. Convene a joint OIT and 311 service design sprint.
* **90 Days:** Launch public-facing performance dashboards. Collect resident feedback on the prototypes. Compile and organize submission materials for the next CDG Digital Cities Survey cycle to begin closing the recognition gap.

## References

1. *Digital Cities Survey 2020 Winners Announced*. https://www.govtech.com/dc/digital-cities/Digital-Cities-Survey-2020-Winners-Announced.html
2. *Digital Cities Survey 2025 Winners Announced*. https://www.govtech.com/dc/digital-cities/digital-cities-survey-2025-winners-announced
3. *Results for America Awards 12 New Cities With Bloomberg Philanthropies What Works Cities Certification for Exceptional Use of Data | What Works Cities*. https://whatworkscities.bloomberg.org/news/january-2024-certification/
...
11. *PP Payment Center*. https://rvapay.rva.gov/
